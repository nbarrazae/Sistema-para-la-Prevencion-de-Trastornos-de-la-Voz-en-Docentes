"""
Django settings for Proyecto_De_Titulo project.
...
ROOT_URLCONF = 'Proyecto_De_Titulo.urls'
...
WSGI_APPLICATION = 'Proyecto_De_Titulo.wsgi.application'
...
MQTT_BROKER = "146.83.194.142"  # Broker Victor
MQTT_PORT = 1712  # Puerto MQTT --> 1883
